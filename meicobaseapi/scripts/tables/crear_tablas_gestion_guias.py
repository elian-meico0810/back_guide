        ...
        try:
            ...
            cursor.execute("""
                CREATE TABLE dbo.PlanillaDetalleFactura (
                    ...
                    FechaDespacho VARCHAR(255) NULL,
                    TipoGuia VARCHAR(255) NULL,
                    TipoIdPropietarioTransportador VARCHAR(100) NULL,
                    IdPropietarioTransportador VARCHAR(100) NULL,		
					NombrePropietarioTransportador VARCHAR(100) NULL,			
					...
					FechaPromesa VARCHAR(100) NULL,								
					FechaRetorno VARCHAR(100) NULL,			
                    ...
                    ValorRecaudado DECIMAL(18,4) NULL,
            ...
            CREATE TABLE dbo.Documentos (
                ...
                NumeroDocumento VARCHAR(50) NULL,
                TipoDocumento VARCHAR(255) NULL,
                ValorDocumento DECIMAL(18,4) NULL,
            ...
            cursor.execute("""
                CREATE TABLE dbo.PlanillaDetalles (
                    ...
                    ValorRecaudar DECIMAL(18,4) NULL,
                );
            """)
            conn.commit()
