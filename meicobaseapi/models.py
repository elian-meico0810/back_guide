...
class PlanillaDetalleFactura(Auditoria):
    ...
    dfr_factura = models.DecimalField(max_digits=15, decimal_places=4, null=True, blank=True, help_text="Diferencia de facturas")
    ...
    dfr_real = models.DecimalField(max_digits=15, decimal_places=4, null=True, blank=True, help_text="Diferencia real")
